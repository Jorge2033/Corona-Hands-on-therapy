...
const en = {
  ...
  teamMembers: {
    ...
    "esther-acupuncture": { role: "Acupuncturist", note: "Treats pain and muscle tension with acupuncture alongside each patient's therapy plan." },
    ...
    "karen-front-desk": { role: "Front Desk", note: "Checks patients in, manages the appointment book, and answers day-to-day questions." },
    "kally-records": { role: "Medical Records", note: "Maintains patient charts and handles medical record requests from providers and attorneys." },
...
const es: TranslationDict = {
  ...
  teamMembers: {
    ...
    "esther-acupuncture": { role: "Acupunturista", note: "Trata el dolor y la tensión muscular con acupuntura junto al plan de terapia de cada paciente." },
    ...
    "karen-front-desk": { role: "Recepción", note: "Registra a los pacientes, administra la agenda de citas y responde las consultas del día a día." },
    "kally-records": { role: "Registros Médicos", note: "Mantiene los expedientes de los pacientes y gestiona las solicitudes de registros médicos de proveedores y abogados." },
