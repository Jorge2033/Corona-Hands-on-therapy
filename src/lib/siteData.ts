...
export const SERVICES = [
  ...
  },
  {
    ...
    // Sin proveedor asignado todavía: la tarjeta omite la línea del médico.
    provider: "",
    description:
...
export const TEAM = [
  ...
  {
    id: "esther-acupuncture",
    department: "Clinical Care",
    name: "Esther",
    role: "Acupuncturist",
    note: "Treats pain and muscle tension with acupuncture alongside each patient's therapy plan.",
    initials: "E",
    photo: null as string | null,
  },
  {
  ...
  {
    id: "daniela-front-desk",
    department: "Patient Support & Administration",
    name: "Daniela",
    role: "Front Desk",
    note: "Greets patients on arrival, answers calls, and keeps the front desk running smoothly.",
    initials: "D",
    photo: null as string | null,
  },
  {
  ...
  },
  {
    ...
    name: "Karen",
    role: "Front Desk",
    note: "Checks patients in, manages the appointment book, and answers day-to-day questions.",
    initials: "K",
    photo: null as string | null,
  },
  {
    ...
    note: "Maintains patient charts and handles medical record requests from providers and attorneys.",
    initials: "K",
    photo: null as string | null,
  },
  {
